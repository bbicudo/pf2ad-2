...
fetch -o /usr/local/pkg -q https://raw.githubusercontent.com/jopnine/pf2ad/homolaga%C3%A7%C3%A3o/samba.inc
fetch -o /usr/local/pkg -q https://raw.githubusercontent.com/jopnine/pf2ad/homolaga%C3%A7%C3%A3o/samba.xml
...
cd /usr/local/pkg
fetch -o - -q https://raw.githubusercontent.com/jopnine/pf2ad/homolaga%C3%A7%C3%A3o/squid_winbind_auth.patch | patch -b -p0 -f
fetch -o /usr/local/pkg -q https://raw.githubusercontent.com/jopnine/pf2ad/homolaga%C3%A7%C3%A3o/squid.inc
